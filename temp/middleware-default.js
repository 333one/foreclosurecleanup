...
exports.pageNotFound = wrapAsync(async function(req, res) {
    ...
    res.status(404).render('page-not-found', { activeLink, contactEmail, loggedIn, projectStatus });
...
exports.privacyPolicy = wrapAsync(async function(req, res) {
    ...
    res.render('privacy-policy', { activeLink, contactEmail, loggedIn, projectStatus });
...
exports.termsOfService = wrapAsync(async function(req, res) {
    ...
    res.render('terms-of-service', { activeLink, contactEmail, loggedIn, projectStatus });
