...
function rollOverIcon() {
    ...
    document.getElementById('targetVendorIcon').setAttribute('src', 'images/vendor-icon-gold.svg');
}
...
function rollOffIcon() {
    ...
    document.getElementById('targetVendorIcon').setAttribute('src', 'images/vendor-icon-white.svg');
}